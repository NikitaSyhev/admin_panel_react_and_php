...
export default class EditorMeta extends Component {
    ...
    //Метод используется для получения текущих значений мета-тегов заголовка, ключевых слов и описания
    componentDidMount() {
    ...
    //получение значения из виртуального DOM для трёх основных элементов мета-данных: title, keywords и description
    getMeta(virtualDom) {
